package ru.clevertec.cashier.parser;

import org.springframework.stereotype.Component;
import ru.clevertec.cashier.exception.ParserException;
import ru.clevertec.cashier.validator.ParameterValidator;

import java.util.HashMap;
import java.util.Map;

import static ru.clevertec.cashier.exception.ExceptionMessage.COULD_NOT_PARSE_GIVEN_PARAMETER;
